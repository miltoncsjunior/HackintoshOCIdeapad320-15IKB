...
A guide for installing macOS Sequoia 15.3.1 on Lenovo Ideapad 320-15IKB using OpenCore 1.0.4 UEFI.
![](Images/Laptop.png)
...
- <b>Storage</b>: 240Gb SSD (Upgraded)
...
## What's Not Working?
- Wi-Fi in networks with mesh routers (Airportitlwm.kext, with itlwm.kext work)
...
## Requirement 
- 32GB USB drive 
- macOS Sequoia image downloaded from the Appstore 
...
```
- Install Patch Wi-Fi (Required after install and after OS updates)
	1. In config.plist enable fake device Broadcom in DP section e restart machine
	2. Install Opencore Legacy Patch and install root patches, after disable fake device enabled in step 1
- Install hotkey package
...
- If you don't like the name of your laptop that shown in "About This Mac", you can change it! Press Shift+Cmd+G <kbd>⇧⌘G</kbd> and copy-and-paste this path: `/Users/Username/Library/Preferences/com.apple.SystemProfiler.plist`, and remember, the word `Username` Is for your username, now download your favorite plist editor (mine is "PilstEdit Pro"), then you can change to `Lenovo Ideapad (320-15IKB 80YH)` or any name you want.
![](Images/Edit.png)
